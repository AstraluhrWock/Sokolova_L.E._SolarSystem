...
public class PlayerLabel : MonoBehaviour
{
    public void DrawLabel(Camera camera)
    {
        ...
        for (int i = 0; i < objects.Count; i++)
        {
            ...
            if (collider != null && IsColliderVisibleFromCamera(collider, camera) && obj.transform != transform)
            {
    ...
    private bool IsColliderVisibleFromCamera(Collider col, Camera camera)
    {
